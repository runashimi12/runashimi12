# Generated by Django 2.2.12 on 2021-11-08 05:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(default='estudiante', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('rol', models.ForeignKey(default='estudiante', null=True, on_delete=django.db.models.deletion.SET_NULL, to='lecciones.Rol')),

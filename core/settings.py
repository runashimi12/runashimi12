...
ALLOWED_HOSTS = ['localhost', '0.0.0.0', config('SERVER', default='0.0.0.0')]
# ALLOWED_HOSTS =['*']
...
#AUTH_USER_MODEL = 'lecciones.User'
...
EMAIL_PORT = 587
EMAIL_HOST_USER ='runashimi.1532@gmail.com'
EMAIL_HOST_PASSWORD ='25633638'
EMAIL_USE_TLS = True
